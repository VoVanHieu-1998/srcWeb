...
<%@ page import="vn.nlu.fit.utils.MyUtils" %>
<%@ page import="vn.nlu.fit.controllers.clients.MobileListServlet" %>
...
<jsp:include page="/mobileList"></jsp:include>
<%
    ArrayList<Product> firstMobileList = (ArrayList<Product>) request.getAttribute("firstMobileList");
                    ...
                    <div class="product col-sm-3 col-12">
                        <a href="<%= Util.fullPath("DetailProduct?id="+p.getCode())%>">
                            ...
                            <div class="content">
                                ...
                                <div class="price">
                                    <strong>
                                        <%= Util.vndCurrency(p.getPromotionPrice())%>
                                    </strong>
                                    <span>
                                        <%= Util.vndCurrency(p.getPrice())%>
                                    </span>
                                </div>
                                <div class="rating">
                                ...
                                <lablel class="discount">
                                    GIẢM <%= Util.vndCurrency(p.getPrice() - p.getPromotionPrice())%>
                                </lablel>
                                <div class="promo">

...
<jsp:include page="/laptopList"></jsp:include>
<%
    ArrayList<Product> firstLaptopList = (ArrayList<Product>) request.getAttribute("firstLaptopList");

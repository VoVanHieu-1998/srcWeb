...
<div id="sidebar" class="sidebar responsive ace-save-state">
    ...
    <ul class="nav nav-list">
        ...
        <li class="open">
            ...
            <ul class="submenu">
                ...
                <li class="">
                    <a href="<c:url value="/admin/comment/list"/> ">
                        <i class="menu-icon fa fa-caret-right"></i>
                        Quản lý bình luận
                    </a>
    ...
    <script src="<c:url value='/resources/admin/assets/js/jquery-2.1.4.min.js' />"></script>
                    ...
                    success: function (data) {
                        ...
                        if (resultValid == 'success') {
                            ...
                            if (myObj.resultDuplicated == 'success') {
                                ...
                                console.log('resultDuplicated error');
                                $('#catalog-name').parent().find('.error').remove();
                                $('#catalog-name').parent().append('<div class="error" style="color:#ff0000">' + myObj.resultDuplicated + '</div>');
                            }
                        } else {
                            console.log('valid error');
                            $('#catalog-name').parent().find('.error').remove();

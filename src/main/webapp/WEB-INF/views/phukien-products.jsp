...
<jsp:include page="/phuKienList"></jsp:include>
<%
    ArrayList<Product> firstPhuKienList = (ArrayList<Product>) request.getAttribute("firstPhuKienList");
    ...
    <div class="container">
        ...
        <div class="list-product">
            <div class="product-item">
                <div class="row">
                    <!-- Một sản phẩm -->
                    <% for (Product p : firstPhuKienList) { %>

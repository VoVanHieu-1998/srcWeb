...
<%--            <div class="ace-nav">--%>
<%--                <div>Ten san pham<input type="text" name="name" ></div>--%>
<%--                <div><select class="select2-search-field">--%>
...
<%--                    <option value="1">5tr-9tr</option>--%>
<%--                    <option value="2">3tr-5tr</option>--%>
<%--                    <option value="3">>10tr/option>--%>
<%--                </select>--%>
<%--                <button class="buttons_wrapper" type="submit"/>--%>
<%--                </div>--%>
<%--            </div>--%>
                                ...
                                <div>
                                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="product-name-col ${item.productCode}">
                                                ...
                                                <td class="hidden-480 color-blue">${item.price}
                                                </td>
                                                <td class="color-blue">${item.promotionPrice}
                                                </td>
                                                <td class="color-blue">${item.quantity}
                                                </td>
                                                <td class="hidden-480">
                                                    ...
                                                    <label>
                                                        <input name="switch-field-1" class="ace ace-switch ace-switch-7"
                                                               ...
                                                               onclick="callChangeStatusServlet('${item.productCode}')">
                                                        <span class="lbl"></span>
                                                    </label>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="hidden-sm hidden-xs action-buttons">
                                                        <a class="green"
                                                           href=<c:url value="/admin/product/edit/${item.productCode}" />>
                                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                        </a>

                                                        <a class="red" href="#exampleModal" data-toggle="modal"
                                                           data-product-id="${item.productCode}">
                                    ...
                                    <ul class="pagination pagination-sm">
                                        <c:forEach begin="1" end="${page.totalPages}"
                                            ...
                                            <c:choose>
                                                <c:when test="${page.indexPage == loop.index}">
                                                ...
                                                <c:otherwise>
                                                    <li class="paginate_button"
                                                        style="background-color: teal; margin-right: 5px; width: 20px; text-align: center;"><a
                                                            href="<c:url value="/admin/product/list/${loop.index}" />">${loop.index}</a></li>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary"
                       href=<c:url value="/admin/product/delete/"/>>ĐỒNG Ý</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function callChangeStatusServlet(code) {
        ...
        $.ajax({
            ...
            url : '<c:url value="/admin/product/changeStatusProduct/" />'+code,

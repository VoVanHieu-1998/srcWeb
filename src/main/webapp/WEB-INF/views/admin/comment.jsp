                                ...
                                <div>
                                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                        ...
                                        <c:forEach var="item" items="${commentList}">
                                            <tr>
                                                <td class="product-name-col ${item.name}">
                                                ...
                                                <td class="color-blue">${item.phoneNumber}
                                                </td>
                                                <td class="color-blue">${item.email}
                                                </td>
                                                <td class="hidden-480">
                                                    ...
                                                    <label>
                                                        <input name="switch-field-1" class="ace ace-switch ace-switch-7"
                                                            ...
                                                            ${item.activeFlag==1?"checked":""}
                                                               onclick="callChangeStatusServlet('${item.commentId}')">
                                                        <span class="lbl"></span>
                                                    </label>
                                                </td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary"
                       href=<c:url value="/admin/comment/delete/"/>>ĐỒNG Ý</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    $('#exampleModal').on('show.bs.modal', function (e) {
        $('#exampleModal').find('.modal-body').html("Bạn có đồng ý xóa bỏ bình luận này không?");
        var hrefFix = href;
        var comment = $(e.relatedTarget).data('comment-id');
        if (comment != undefined) {
            // console.log(href);
            $('#exampleModal').find('.modal-footer').find('a').attr("href", hrefFix + comment);
        }
    });

    // call proceed2CheckoutServlet
    function callChangeStatusServlet(id) {
        console.log(id);

        $.ajax({
            type : "GET",
            // contentType : "application/json",
            url : '<c:url value="/admin/comment/changeStatusProduct/" />'+id,

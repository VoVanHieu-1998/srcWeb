                        ...
                        <div class="col-sm-8">
                            <form action="" class="p-3">
                                ...
                                <div>
                                    ...
                                    <div class="d-inline-block" id="dateOB">
                                        <select class="day">
                                ...
                                <div>
                                    ...
                                    <div class="d-inline-block"><input type="text" name="" id="pass-2" placeholder="Mật khẩu từ 6 đến 32 ký tự"></div>
                                </div>
                                <div>
